...
- Updated bundled `@mariozechner/pi-coding-agent` dependency from `^0.54.0` to `^0.54.2`.
...
- Updated bundled `@mariozechner/pi-coding-agent` dependency from `^0.53.0` to `^0.54.0`.
